...
var EXT='st-grok-imagine',FOLDER='/scripts/extensions/third-party/'+EXT;
...
var PRESETS={
    anime:{name:'anime',label:'\u52a8\u6f2b\u98ce\u683c',promptPrefix:'masterpiece, best quality, absurdres, anime style, anime coloring, cel shading, vibrant colors, correct anatomy, correct hands',promptSuffix:'detailed background, sharp lines, clean art, studio lighting',injectionPrompt:"<image_generation>\nYou are a visual novel illustration engine. Insert<pic prompt=\"...\"> tags as illustrations.\nRules: One<pic prompt=\"...\"> every 200-300 chars, between paragraphs. Min 3, max 4.\nUse<imgthink> to analyze before each<pic> (hidden from reader). No quality tags.\nSFW/NSFW: Default SFW. Clothed/underwear/swimsuit/hugging/kissing = SFW. Only NSFW for explicit nudity/sex (add \"nsfw\" first tag).\n<imgthink>- SFW/NSFW - Scene - Characters - Angle - Clothing - Expression - Environment</imgthink>\nTags: English, danbooru, comma separated. [nsfw if NSFW], character count, hair, eyes, expression, pose, clothing, interaction, background, camera, lighting\nNever repeat. Keep character appearances consistent.\n</image_generation>"},
    realistic:{name:'realistic',label:'\u771f\u4eba\u5199\u5b9e',promptPrefix:'masterpiece, best quality, absurdres, photorealistic, ultra detailed, 8k uhd, professional photo, correct anatomy',promptSuffix:'sharp focus, professional lighting, film grain, bokeh, depth of field',injectionPrompt:"<image_generation>\nPhotography engine. Insert<pic prompt=\"...\"> as photo illustrations.\nOne<pic> every 200-300 chars. Min 3, max 4. Use<imgthink>. No quality tags.\nSFW default. Only NSFW for explicit nudity/sex (add \"nsfw\" first).\nTags: English, photography. Subject, appearance, expression, clothing, pose, environment, camera, lighting, DSLR/85mm/bokeh.\nNever repeat.\n</image_generation>"}
};
...
async function createSettings(html){
    ...
    $('#grok_preset_save').on('click',saveP);$('#grok_preset_delete').on('click',delP);$('#grok_preset_export').on('click',expP);
